...
def get_locations(world: "PoRWorld") -> List[LocationData]:
    location_table: List[LocationData] = [
        ...
        LocationData("City of Haze - Post-Boss", "City of Haze: Heavy Cart Item"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Axe Courtyard"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Left Dance Hall Left Item"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Left Dance Hall Right Item"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Dance Halls Basement"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Right Dance Hall Item"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Right Dance Hall Secret Room"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Post-Boss Room"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Tunnel Room Right"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Tunnel Room Left"),
        LocationData("City of Haze - Post-Boss", "City of Haze: Dance Halls Vertical Hallway"),
        ...
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Left Big Corner"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Lower Left Big Room"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Lower Vertical Hall"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Bottom Corner"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Bottom Right Breakable Wall"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Bottom Right Big Room"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Bottom Right Corner Room"),
        LocationData("Burnt Paradise - Entrance", "Burnt Paradise: Boss Room", True),
