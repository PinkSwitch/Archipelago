...
def setup_gamevars(world):
    ...
    if world.options.world_state == 2:
        ...
        world.light_gate = world.options.world_state.value
        world.sun_gate = world.options.world_state.value
        world.star_gate = world.options.world_state.value
        world.aqua_gate = world.options.world_state.value
        world.moon_gate = world.options.world_state.value
    ...
    if world.options.shortcut_states == 2:
        ...
        world.boa_hiya_shortcut = world.options.shortcut_states.value
        world.sala_hiya_shortcut = world.options.shortcut_states.value
        world.sala_puka_shortcut = world.options.shortcut_states.value
        world.fuwa_poka_shortcut = world.options.shortcut_states.value
        world.fuwa_puka_shortcut = world.options.shortcut_states.value
