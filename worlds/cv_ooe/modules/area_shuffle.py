...
door_data = {
    "Sec00Rm07": DoorTransitionData(0x022ABC70, 0x022ABC80, 0x00, 0x00, "Castle Entrance: Upper Door", True),
    "Sec03Rm00": DoorTransitionData(0x022ACB70, 0x022ACB80, 0x00, 0x180, "Library: West Door"),

    "Sec01Rm03": DoorTransitionData(0x022ABEE0, 0x022ABEF0, 0x00, 0x00, "Castle Entrance: Lower Door", True),
    "Sec02Rm00": DoorTransitionData(0x022AC2D8, 0x022AC2B8, 0x00, 0x00, "Underground Labyrinth: West Door"),

    "Sec02Rm0E": DoorTransitionData(0x022AD578, 0x022AD588, 0x00, 0x00, "Underground Labyrinth: East Door", True),
    "Sec05Rm04": DoorTransitionData(0x022AD528, 0x022AD4E8, 0x00, 0x0180, "Barracks: Lower West Door"),

    "Sec01Rm07": DoorTransitionData(0x022AD458, 0x022AD468, 0x00, 0x00, "Castle Entrance: Shortcut Door", True),
    "Sec05Rm03": DoorTransitionData(0x022AD4B8, 0x022AD488, 0x100, 0x00, "Barracks: Upper West Door"),
    ...
    "Sec09Rm07": DoorTransitionData(0x022AF1B8, 0x022AF1C8, 0x00, 0x00, "Forsaken Cloister: East Door", True),
    "Sec06Rm0B": DoorTransitionData(0x022ADC38, 0x022ADC58, 0x00, 0x00, "Mechanical Tower: Upper Door"),

    "Sec08Rm02": DoorTransitionData(0x022AD978, 0x022AD988, 0x00, 0x00, "Arms Depot: Exit Door", True),
