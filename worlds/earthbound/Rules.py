...
def set_location_rules(world: "EarthBoundWorld") -> None:
    ...
    set_rule(world.multiworld.get_location("Deep Darkness - Dirt Present", player), lambda state: state.has("Hawk Eye", player))
    set_rule(world.multiworld.get_location("Deep Darkness - Alcove Present", player), lambda state: state.has("Hawk Eye", player))
    set_rule(world.multiworld.get_location("Deep Darkness - North Truffle", player), lambda state: state.has_all({'Piggy Nose', 'Hawk Eye'}, player))
    set_rule(world.multiworld.get_location("Deep Darkness - South Truffle", player), lambda state: state.has_all({'Piggy Nose', 'Hawk Eye'}, player))
    set_rule(world.multiworld.get_location("Deep Darkness - Center Truffle", player), lambda state: state.has_all({'Piggy Nose', 'Hawk Eye'}, player))
    set_rule(world.multiworld.get_location("Deep Darkness - Southeast Truffle", player), lambda state: state.has_all({'Piggy Nose', 'Hawk Eye'}, player))
