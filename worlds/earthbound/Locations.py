...
def get_locations(world: "EarthBoundWorld") -> List[LocationData]:
    ...
    LocationData("Peaceful Rest Valley", "Peaceful Rest Valley - Hill Near Bridge Present", 0xEB001D),
    LocationData("Peaceful Rest Valley", "Peaceful Rest Valley - Temptation Hill Present", 0xEB001E),
    ...
    LocationData("Peaceful Rest Valley", "Peaceful Rest Valley - Southeast River Overlook Present", 0xEB0021),
    LocationData("Peaceful Rest Valley", "Peaceful Rest Valley - Near East Exit Present", 0xEB0022),
    ...
    LocationData("Grapefruit Falls", "Threed Underground - Left Coffin", 0xEB0033),
    LocationData("Grapefruit Falls", "Threed Underground - Right Coffin", 0xEB0034),
    ...
    LocationData("Dusty Dunes Desert", "Dusty Dunes - Far North Present", 0xEB004A),
    ...
    LocationData("Dusty Dunes Desert", "Dusty Dunes - South of North Central Present", 0xEB004E),
    ...
    #LocationData("Snow Wood Boarding School", "Snow Wood - Many Present Room Present #7", 0xEB0058),
    ...
    LocationData("Southern Winters", "Brick Road Maze - Eastern Present", 0xEB0061),
    ...
    LocationData("Rainy Circle", "Rainy Circle - East Path Present", 0xEB0065),
    LocationData("Rainy Circle", "Rainy Circle - Right Cliff Present", 0xEB0066),
    ...
    LocationData("Gold Mine", "Gold Mine - B1F Mole Present", 0xEB0076),
    LocationData("Gold Mine", "Gold Mine - South Hall Present", 0xEB0077),
    LocationData("Gold Mine", "Gold Mine - South Crossroad Present", 0xEB0078),
    ...
    LocationData("Fourside", "Moonside - Southwest Present", 0xEB008E),
    ...
    LocationData("Fourside", "Fourside - Department Store Blackout", 0xEB0093),
    LocationData("Magnet Hill", "Fourside Sewers - West Entrance Trashcan", 0xEB0094),
    LocationData("Magnet Hill", "Fourside Sewers - First Room Free Door Trashcan", 0xEB0095),
    LocationData("Magnet Hill", "Fourside Sewers - First Room Barrel Door Trashcan", 0xEB0096),
    LocationData("Magnet Hill", "Fourside Sewers - Second Room Dead End Trashcan", 0xEB0097),
    LocationData("Magnet Hill", "Fourside Sewers - Final Room Door Trashcan", 0xEB0098),
    ...
    LocationData("Summers", "Summers - Museum Item", 0xEB009F),
    ...
    LocationData("Dalaam", "Dalaam - Do Do Guy House Chest", 0xEB00A7),
    ...
    LocationData("Pyramid", "Pyramid - From Entrance Sarcophagus", 0xEB00AE),
    ...
    LocationData("Dungeon Man", "Dungeon Man - 1F East Present", 0xEB00B7),
    ...
    LocationData("Dungeon Man", "Dungeon Man - 1F Double Billboard Present", 0xEB00BA),
    ...
    LocationData("Deep Darkness", "Deep Darkness - Teach the Monkey to Teleport", 0xEB00C3),
    ...
    LocationData("Deep Darkness", "Deep Darkness - Dirt Present", 0xEB00C8),
    LocationData("Deep Darkness", "Deep Darkness - Alcove Present", 0xEB00C9),
    LocationData("Deep Darkness", "Deep Darkness - North Truffle", 0xEB00CA),
    LocationData("Deep Darkness", "Deep Darkness - South Truffle", 0xEB00CB),
    LocationData("Deep Darkness", "Deep Darkness - Center Truffle", 0xEB00CC),
    LocationData("Deep Darkness", "Deep Darkness - Southeast Truffle", 0xEB00CD),
    ...
    LocationData("Fire Spring", "Fire Spring - Lower Ledge Present", 0xEB00E7),
