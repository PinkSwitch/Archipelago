...
def get_locations(world: "DosWorld") -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData("Subterranean Hell Central Lower", "Subterranean Hell: Behind Waterfall", 0x6A),
        LocationData("Subterranean Hell Central Lower", "Subterranean Hell: Waterfall Room Lower", 0x6B),
        LocationData("Subterranean Hell Central Lower", "Subterranean Hell: Waterfall Room Middle", 0x6C),
        LocationData("Subterranean Hell Central Lower", "Subterranean Hell: Waterfall Room Upper", 0x6D),
